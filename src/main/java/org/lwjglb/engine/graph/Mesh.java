...
public class Mesh {
    ...
    public Mesh(float[] positions, float[] normals, float[] tangents, float[] bitangents, float[] textCoords, int[] indices,
        ...
        vboIdList.add(vboId);
        FloatBuffer positionsBuffer = createFloatBuffer(positions);
        ...
        vboId = glGenBuffers();
        vboIdList.add(vboId);
        FloatBuffer normalsBuffer = createFloatBuffer(normals);
        ...
        vboId = glGenBuffers();
        vboIdList.add(vboId);
        FloatBuffer tangentsBuffer = createFloatBuffer(tangents);
        ...
        vboId = glGenBuffers();
        vboIdList.add(vboId);
        FloatBuffer bitangentsBuffer = createFloatBuffer(bitangents);
